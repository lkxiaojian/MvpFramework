package com.wzrd.v.view.recycleview.load;
...
public class CircleLoadingView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mIndicatorColor = a.getColor(R.styleable.CircleLoadingView_cv_progress_color, Color.WHITE);
        a.recycle();
        mPaint = new Paint();
